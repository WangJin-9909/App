...
public class TabView extends View {
    ...
    public int mTextColorSelected = 0xFF46C01B;  //述文本的默认选中显示颜色
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIconNormal != null && mIconSelected != null) {
            ...
            int offset = mIconSelected.getWidth() - mIconNormal.getWidth();
            if (offset > 0) {
                //控制不与下面文本重叠
                if (offset > mPadding) {
                    offset = mPadding;
                }
                int left = (int) (drawRect.left - offset);
                int top = (int) (drawRect.top - offset);
                int right = (int) (drawRect.right + offset);
                int bottom = (int) (drawRect.bottom + offset);
                ...
                if (bottom > (mIconAvailableRect.bottom + mPadding)) {
                    bottom = mIconAvailableRect.bottom + mPadding;
                }
    ...
    public void setIconNormal(Bitmap mIconNormal) {
        this.mIconNormal = mIconNormal;
    }

    public void setIconSelected(Bitmap mIconSelected) {
