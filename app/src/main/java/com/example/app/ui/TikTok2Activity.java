...
public class TikTok2Activity extends BaseActivityTikTok<VideoView> {

    /**
     * 当前播放位置
     */
    private int mCurPos;
    private List<TiktokBean> mVideoList = new ArrayList<TiktokBean>();
    ...
    private void startPlay(int position) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (viewHolder.mPosition == position) {
                ...
                AppLogger.i("startPlay: " + "position: " + position + "  url: " + playUrl);
